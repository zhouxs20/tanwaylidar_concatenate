...
int main (int argc, char** argv)
{
  ...
  reader.read ("/home/zxs/test_bag1/pcd/1676959842.382605000.pcd", *cloud); // 点云文件
  ...
  vg.setLeafSize (0.1f, 0.1f, 0.1f);  // setLeafSize (float lx, float ly, float lz)
  ...
  for (std::vector<pcl::PointIndices>::const_iterator it = cluster_indices.begin (); it != cluster_indices.end (); ++it)
  {
    ...
    std::stringstream ss;
    ss << "/home/zxs/catkin_test/src/test1/cloud_cluster_" << j << ".pcd";
    writer.write<pcl::PointXYZ> (ss.str (), *cloud_cluster, true); // 保存文件
    j++;
  }
